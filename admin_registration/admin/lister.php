        ...
        <table class="table table-striped table-dark">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="row"><img src="../../img/<?= utf8_encode($produits["image"]) ?>"
                            style="width:100%; height: auto;"></td>
                    <td scope="row"><?= $produits ['resume'] ?></td>
                    <td scope="row"><img src="../../img/<?= $produits ['image_pegi'] ?>"
                            style="width:60%; height: auto;">

                    </td>
                    <td scope="row"><button><a
                                href="form_modification.php?numProduit=<?= $produits['id'] ?>">Modifier</a></button>
                    </td>
                    <td scope="row"><button><a
                                href="supprimer.php?numProduit=<?= $produits['id'] ?>">Supprimer</a></button></td>
