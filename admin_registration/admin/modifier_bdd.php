    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">Ces informations seront affichées publiquement, alors faites
            ...
            <form action="./envoi_donnees.php" method="POST" enctype="multipart/form-data">
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div>
                            <label for="description" class="block text-sm font-medium text-gray-700"> Description du jeu
                            </label>
                            <div class="mt-1">
                            ...
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="text-base font-medium text-gray-900" aria-hidden="true">Type de
                                        ...
                                        <div class="mt-4 space-y-4">
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm">
                                                    <label for="adultes" class="font-medium text-gray-700">A partir de
                                                        16 ans</label>
                                                </div>
                                            </div>
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm">
                                                    <label for="enfants" class="font-medium text-gray-700">A partir de
                                                        12 ans</label>
                                                </div>
                                            </div>
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm">
                                                    <label for="enfants" class="font-medium text-gray-700">A partir de 7
                                                        ans</label>
                                                </div>
                                            </div>
                                            <div class="flex items-start">
                                                ...
                                                <div class="ml-3 text-sm">
                                                    <label for="enfants" class="font-medium text-gray-700">A partir de 3
                                                        ans</label>
                                                </div>
                                            </div>
                                            <div>
