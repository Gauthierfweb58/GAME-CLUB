...
$pdoStat->bindValue(':num',$numProduit,PDO::PARAM_INT);
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="resume" name="resume" value="<?= $produits['resume']; ?>" rows="3"
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="description" name="description" value="<?= $produits['description']; ?>"
                                    rows="3"
                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="console" name="console" value="<?= $produits['console']; ?>" rows="3"
                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="video" name="video" value="<?= $produits['video']; ?>" rows="3"
                                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                            </div>
                        </div>
                  ...
                  ?>
                                            ...
                                            <div>
                                                ...
                                                <img id="add-img" src="../../img/<?= $produits['modif_image']; ?>"
