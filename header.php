<header>
        ...
        <div id="sidebarMenu">
            <nav>
                <ul class="sidebarMenuInner">
                    ...
                    <li><a href="http://www.1980-games.com/?msclkid=a27b45c7cf9911eca923896ebd2b115f"
                            target="_blank">JEUX ANCIENS</a></li>
    ...
    <nav class="grand_ecran">
        <ul>
            ...
            <?php } ?>
            <li>
                <a href="formulaire_inscription.php">CREER UN COMPTE</a>
            </li>
        </ul>
    </nav>
